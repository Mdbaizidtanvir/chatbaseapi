...
SECRET_KEY = 'django-insecure-lw3kjfgo*94p3+7o@htaj)a#hfmp((opb-bkxzctl=)vzr$rgo'
...
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles")  # production collectstatic folder
STATICFILES_DIRS = [
